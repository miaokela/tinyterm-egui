...
| `primary_orb_button(ui, size, draw)` | accent-filled orb for a panel's primary action (新增主机 / 新增凭据): solid disc, bright rim, eight machined dashes and a radar sweep along the rim, plus a breathing halo. Use it instead of filling a circle by hand |
